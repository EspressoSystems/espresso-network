...
```*/
    ...
    pub struct constructorCall {
        ...
        #[allow(missing_docs)]
        pub genesisStakeTableState: <LightClient::StakeTableState as alloy::sol_types::SolType>::RustType,
        #[allow(missing_docs)]
        ...
        impl alloy_sol_types::SolConstructor for constructorCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <alloy::sol_types::sol_data::Uint<
                        32,
                    > as alloy_sol_types::SolType>::tokenize(&self.maxHistorySeconds),
                )
            }
        }
    };
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        LightClientMockInstance::<
            ...
            P,
            N,
        >::deploy(provider, genesis, genesisStakeTableState, maxHistorySeconds)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        LightClientMockInstance::<
            ...
            P,
            N,
        >::deploy_builder(provider, genesis, genesisStakeTableState, maxHistorySeconds)
    }
