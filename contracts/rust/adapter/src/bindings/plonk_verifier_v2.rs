...
pub mod PlonkVerifierV2 {
    ...
    >(
        ...
        PlonkVerifierV2Instance::<P, N>::new(address, __provider)
    }
    ...
    {
        PlonkVerifierV2Instance::<P, N>::deploy(__provider)
    }
    ...
    >(
        ...
        PlonkVerifierV2Instance::<P, N>::deploy_builder(__provider)
    }
        ...
        PlonkVerifierV2Instance<P, N>
    {
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<PlonkVerifierV2Instance<P, N>> {
