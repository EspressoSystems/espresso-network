...
pub mod LightClientMock {
    ...
    >(
        ...
        LightClientMockInstance::<P, N>::new(address, provider)
    }
    ...
    {
        LightClientMockInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        LightClientMockInstance::<P, N>::deploy_builder(provider)
    }
        ...
        LightClientMockInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<LightClientMockInstance<P, N>> {
