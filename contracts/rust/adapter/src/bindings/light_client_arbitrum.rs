...
pub mod LightClientArbitrum {
    ...
    >(
        ...
        LightClientArbitrumInstance::<P, N>::new(address, provider)
    }
    ...
    {
        LightClientArbitrumInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        LightClientArbitrumInstance::<P, N>::deploy_builder(provider)
    }
