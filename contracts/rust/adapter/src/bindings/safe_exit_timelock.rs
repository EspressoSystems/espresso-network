...
pub mod SafeExitTimelock {
    ...
    impl alloy_sol_types::SolInterface for SafeExitTimelockCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls>] = &[
                {
                    fn schedule(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn execute(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn getRoleAdmin(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn grantRole(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn isOperation(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn renounceRole(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn updateDelay(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn hasRole(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn cancel(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn getTimestamp(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn revokeRole(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn executeBatch(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
                ...
                {
                    fn getMinDelay(data: &[u8]) -> alloy_sol_types::Result<SafeExitTimelockCalls> {
    ...
    impl alloy_sol_types::SolInterface for SafeExitTimelockErrors {
        ...
        #[allow(non_snake_case)]
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<SafeExitTimelockErrors>] =
                &[
                    {
                        fn FailedInnerCall(
                            data: &[u8],
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<SafeExitTimelockInstance<P, N>>>
    {
        SafeExitTimelockInstance::<P, N>::deploy(__provider, minDelay, proposers, executors, admin)
    }
    ...
    >(
        ...
        SafeExitTimelockInstance::<P, N>::deploy_builder(
