...
pub mod PlonkVerifierV3 {
    ...
    >(
        ...
        PlonkVerifierV3Instance::<P, N>::new(address, __provider)
    }
    ...
    {
        PlonkVerifierV3Instance::<P, N>::deploy(__provider)
    }
    ...
    >(
        ...
        PlonkVerifierV3Instance::<P, N>::deploy_builder(__provider)
    }
        ...
        PlonkVerifierV3Instance<P, N>
    {
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<PlonkVerifierV3Instance<P, N>> {
