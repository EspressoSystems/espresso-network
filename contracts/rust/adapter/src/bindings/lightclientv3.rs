...
pub mod LightClientV3 {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<LightClientV3Instance<T, P, N>>>
    {
        ...
        > LightClientV3Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<LightClientV3Instance<T, P, N>> {
