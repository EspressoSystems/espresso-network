...
pub mod TimelockController {
    ...
    >(
        ...
        TimelockControllerInstance::<P, N>::new(address, provider)
    }
...
pub mod OpsTimelock {
    ...
    >(
        ...
        OpsTimelockInstance::<P, N>::new(address, provider)
    }
    ...
    {
        OpsTimelockInstance::<P, N>::deploy(provider, minDelay, proposers, executors, admin)
    }
    ...
    >(
        ...
        OpsTimelockInstance::<P, N>::deploy_builder(provider, minDelay, proposers, executors, admin)
    }
