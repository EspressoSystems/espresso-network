...
pub mod OpsTimelock {
    ...
    const _: () = {
        ...
        impl cancelReturn {
            fn _tokenize(&self) -> <cancelCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
    ...
    const _: () = {
        ...
        impl executeBatchReturn {
            fn _tokenize(&self) -> <executeBatchCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getOperationStateCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<TimelockController::OperationState as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    const _: () = {
        ...
        impl scheduleReturn {
            fn _tokenize(&self) -> <scheduleCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
    ...
    const _: () = {
        ...
        impl updateDelayReturn {
            fn _tokenize(&self) -> <updateDelayCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
    ...
    impl alloy_sol_types::SolInterface for OpsTimelockCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<OpsTimelockCalls>] = &[
                {
                    fn schedule(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn EXECUTOR_ROLE(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <EXECUTOR_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::EXECUTOR_ROLE)
                    }
                    EXECUTOR_ROLE
                },
                {
                    fn execute(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn isOperationReady(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <isOperationReadyCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::isOperationReady)
                    }
                    isOperationReady
                },
                {
                    fn onERC721Received(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn getRoleAdmin(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn isOperationDone(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <isOperationDoneCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::isOperationDone)
                    }
                    isOperationDone
                },
                {
                    fn grantRole(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn isOperation(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <isOperationCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::isOperation)
                    }
                    isOperation
                },
                {
                    fn renounceRole(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                },
                {
                    fn isOperationPending(
                        ...
                        <isOperationPendingCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::isOperationPending)
                    }
                    isOperationPending
                },
                {
                    fn updateDelay(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <updateDelayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::updateDelay)
                    }
                    updateDelay
                },
                {
                    fn getOperationState(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <getOperationStateCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::getOperationState)
                    }
                    getOperationState
                },
                {
                    fn hashOperation(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <hashOperationCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::hashOperation)
                    }
                    hashOperation
                },
                {
                    fn scheduleBatch(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <scheduleBatchCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::scheduleBatch)
                    }
                    scheduleBatch
                },
                {
                    fn PROPOSER_ROLE(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <PROPOSER_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::PROPOSER_ROLE)
                    }
                    PROPOSER_ROLE
                },
                {
                    fn hasRole(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn CANCELLER_ROLE(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <CANCELLER_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn hashOperationBatch(
                        ...
                        <hashOperationBatchCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn getTimestamp(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <getTimestampCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::getTimestamp)
                    }
                    getTimestamp
                },
                {
                    fn revokeRole(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn executeBatch(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <executeBatchCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(OpsTimelockCalls::executeBatch)
                    }
                    executeBatch
                },
                {
                    fn onERC1155Received(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                ...
                {
                    fn getMinDelay(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <getMinDelayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                {
                    fn schedule(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <scheduleCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(OpsTimelockCalls::schedule)
                    }
                    schedule
                },
                ...
                {
                    fn isOperation(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <isOperationCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(OpsTimelockCalls::isOperation)
                    }
                    isOperation
                },
                ...
                {
                    fn updateDelay(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <updateDelayCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(OpsTimelockCalls::updateDelay)
                    }
                    updateDelay
                },
                ...
                {
                    fn getMinDelay(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockCalls> {
                        <getMinDelayCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(OpsTimelockCalls::getMinDelay)
                    }
                    getMinDelay
                },
    ...
    impl alloy_sol_types::SolInterface for OpsTimelockErrors {
        ...
        #[allow(non_snake_case)]
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<OpsTimelockErrors>] = &[
                {
                    fn FailedInnerCall(data: &[u8]) -> alloy_sol_types::Result<OpsTimelockErrors> {
        ...
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                Some(<CallExecuted as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <CallExecuted as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
                ...
                Some(<CallScheduled as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <CallScheduled as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
                        .map(Self::CallScheduled)
                },
                Some(<Cancelled as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <Cancelled as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
                        .map(Self::Cancelled)
                },
                Some(<MinDelayChange as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <MinDelayChange as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<OpsTimelockInstance<P, N>>>
    {
        OpsTimelockInstance::<P, N>::deploy(__provider, minDelay, proposers, executors, admin)
    }
    ...
    >(
        ...
        OpsTimelockInstance::<P, N>::deploy_builder(
            __provider, minDelay, proposers, executors, admin,
        )
    }
        ...
        OpsTimelockInstance<P, N>
    {
        ...
        pub async fn deploy(
            ...
            let call_builder =
                Self::deploy_builder(__provider, minDelay, proposers, executors, admin);
        ...
        OpsTimelockInstance<P, N>
    {
        ...
        pub fn CANCELLER_ROLE(&self) -> alloy_contract::SolCallBuilder<&P, CANCELLER_ROLECall, N> {
        ...
        pub fn EXECUTOR_ROLE(&self) -> alloy_contract::SolCallBuilder<&P, EXECUTOR_ROLECall, N> {
            self.call_builder(&EXECUTOR_ROLECall)
        }
        ///Creates a new call builder for the [`PROPOSER_ROLE`] function.
        pub fn PROPOSER_ROLE(&self) -> alloy_contract::SolCallBuilder<&P, PROPOSER_ROLECall, N> {
        ...
        pub fn getMinDelay(&self) -> alloy_contract::SolCallBuilder<&P, getMinDelayCall, N> {
        ...
        OpsTimelockInstance<P, N>
    {
        ...
        pub fn CallScheduled_filter(&self) -> alloy_contract::Event<&P, CallScheduled, N> {
        ...
        pub fn MinDelayChange_filter(&self) -> alloy_contract::Event<&P, MinDelayChange, N> {
