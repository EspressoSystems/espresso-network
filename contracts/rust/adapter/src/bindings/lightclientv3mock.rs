...
pub mod LightClientV3Mock {
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn firstEpoch(
                        ...
                        <firstEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn authRoot(
                        ...
                        <authRootCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<LightClientV3MockInstance<T, P, N>>>
    {
        ...
        > LightClientV3MockInstance<T, P, N>
    {
        ...
        pub fn authRoot(&self) -> alloy_contract::SolCallBuilder<T, &P, authRootCall, N> {
        ...
        pub fn firstEpoch(&self) -> alloy_contract::SolCallBuilder<T, &P, firstEpochCall, N> {
        ...
        pub fn initializeV3(&self) -> alloy_contract::SolCallBuilder<T, &P, initializeV3Call, N> {
