...
if is_localhost_rpc "$RPC_URL"; then
    ESPRESSO_OPS_TIMELOCK_PROPOSERS="${ESPRESSO_OPS_TIMELOCK_PROPOSERS:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
    ESPRESSO_OPS_TIMELOCK_EXECUTORS="${ESPRESSO_OPS_TIMELOCK_EXECUTORS:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
    ESPRESSO_SAFE_EXIT_TIMELOCK_PROPOSERS="${ESPRESSO_SAFE_EXIT_TIMELOCK_PROPOSERS:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
    ESPRESSO_SAFE_EXIT_TIMELOCK_EXECUTORS="${ESPRESSO_SAFE_EXIT_TIMELOCK_EXECUTORS:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
    ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER_ADDRESS="${ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER_ADDRESS:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
else
