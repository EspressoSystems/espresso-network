...
# Use hardcoded anvil addresses for localhost if not provided, otherwise use env vars
if is_localhost_rpc "$RPC_URL"; then
    ANVIL_DEFAULT_ADDR="0xa0Ee7A142d267C1f36714E4a8F75612F20a79720"
    ESPRESSO_OPS_TIMELOCK_ADMIN="${ESPRESSO_OPS_TIMELOCK_ADMIN:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_OPS_TIMELOCK_PROPOSERS="${ESPRESSO_OPS_TIMELOCK_PROPOSERS:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_OPS_TIMELOCK_EXECUTORS="${ESPRESSO_OPS_TIMELOCK_EXECUTORS:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_SAFE_EXIT_TIMELOCK_ADMIN="${ESPRESSO_SAFE_EXIT_TIMELOCK_ADMIN:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_SAFE_EXIT_TIMELOCK_PROPOSERS="${ESPRESSO_SAFE_EXIT_TIMELOCK_PROPOSERS:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_SAFE_EXIT_TIMELOCK_EXECUTORS="${ESPRESSO_SAFE_EXIT_TIMELOCK_EXECUTORS:-$ANVIL_DEFAULT_ADDR}"
    ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER_ADDRESS="${ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER_ADDRESS:-$ANVIL_DEFAULT_ADDR}"
else
