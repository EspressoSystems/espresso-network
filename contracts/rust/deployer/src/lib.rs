...
mod tests {
    ...
    async fn test_schedule_and_execute_timelock_operation() -> Result<()> {
        ...
        let mut operation = proposals::timelock_proposals::TimelockOperationData {
        ...
        let operation_id = proposals::timelock_proposals::schedule_timelock_operation(
            &provider,
            Contract::FeeContractProxy,
            operation.clone(),
        )
        ...
        proposals::timelock_proposals::execute_timelock_operation(
            &provider,
            Contract::FeeContractProxy,
            operation.clone(),
        )
        ...
        proposals::timelock_proposals::schedule_timelock_operation(
            &provider,
            Contract::FeeContractProxy,
            operation.clone(),
        )
        ...
        proposals::timelock_proposals::cancel_timelock_operation(
            &provider,
            Contract::FeeContractProxy,
            operation.clone(),
        )
