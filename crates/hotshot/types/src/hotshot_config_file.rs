...
impl<TYPES: NodeType> From<HotShotConfigFile<TYPES>> for HotShotConfig<TYPES> {
    fn from(val: HotShotConfigFile<TYPES>) -> Self {
        HotShotConfig {
            ...
            upgrade_propose_offset: val.upgrade.propose_offset,
            upgrade_decide_by_offset: val.upgrade.decide_by_offset,
            upgrade_begin_offset: val.upgrade.begin_offset,
            upgrade_finish_offset: val.upgrade.finish_offset,
