...
use cliquenet_x25519::{InvalidKeypair, InvalidPublicKey, InvalidSecretKey};
...
pub struct Keypair(cliquenet_x25519::Keypair);

#[derive(Copy, Clone, PartialEq, Eq, Hash, PartialOrd, Ord, Serialize, Deserialize)]
#[serde(transparent)]
pub struct PublicKey(cliquenet_x25519::PublicKey);

#[derive(Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(transparent)]
pub struct SecretKey(cliquenet_x25519::SecretKey);

impl Keypair {
    pub fn generate() -> Result<Self, InvalidKeypair> {
        cliquenet_x25519::Keypair::generate().map(Self)
    }
    ...
    pub fn generated_from_seed_indexed(seed: [u8; 32], index: u64) -> Result<Self, InvalidKeypair> {
        ...
        cliquenet_x25519::Keypair::from_seed(seed).map(Self)
    }
...
impl From<Keypair> for cliquenet_x25519::Keypair {
    fn from(k: Keypair) -> Self {
        k.0
    }
}

impl From<PublicKey> for cliquenet_x25519::PublicKey {
    fn from(k: PublicKey) -> Self {
        k.0
    }
}

impl From<cliquenet_x25519::PublicKey> for PublicKey {
    fn from(k: cliquenet_x25519::PublicKey) -> Self {
        Self(k)
    }
}
...
impl TryFrom<&[u8]> for PublicKey {
    ...
    fn try_from(s: &[u8]) -> Result<Self, Self::Error> {
        Ok(Self(cliquenet_x25519::PublicKey::try_from(s)?))
    }
}
...
impl TryFrom<&[u8]> for SecretKey {
    ...
    fn try_from(s: &[u8]) -> Result<Self, Self::Error> {
        Ok(Self(cliquenet_x25519::SecretKey::try_from(s)?))
    }
}
...
impl TryFrom<[u8; 32]> for SecretKey {
    ...
    fn try_from(a: [u8; 32]) -> Result<Self, Self::Error> {
        Ok(Self(cliquenet_x25519::SecretKey::try_from(a)?))
    }
}
