...
/// The v2 API contract, generated by `build.rs` from the proto files in `proto/`:
/// message types plus tonic client and server stubs, and the canonical protoJSON
/// Serialize/Deserialize impls that define the HTTP wire encoding.
pub mod proto {
