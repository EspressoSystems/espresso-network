...
impl serde::Serialize for ExplorerBlockDetail {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.block_reward.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerBlockDetail", len)?;
        if !self.hash.is_empty() {
            struct_ser.serialize_field("hash", &self.hash)?;
        }
        if self.height != 0 {
        ...
        if !self.proposer_id.is_empty() {
            struct_ser.serialize_field("proposerId", &self.proposer_id)?;
        }
        if !self.fee_recipient.is_empty() {
            struct_ser.serialize_field("feeRecipient", &self.fee_recipient)?;
        }
        ...
        if !self.block_reward.is_empty() {
            struct_ser.serialize_field("blockReward", &self.block_reward)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerBlockDetail {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "feeRecipient" | "fee_recipient" => Ok(GeneratedField::FeeRecipient),
                            "size" => Ok(GeneratedField::Size),
                            "blockReward" | "block_reward" => Ok(GeneratedField::BlockReward),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerBlockDetail;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerBlockDetail")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerBlockDetail, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut hash__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ProposerId => {
                            ...
                            proposer_id__ = Some(map_.next_value()?);
                        }
                        GeneratedField::FeeRecipient => {
                            if fee_recipient__.is_some() {
                                return Err(serde::de::Error::duplicate_field("feeRecipient"));
                        ...
                        GeneratedField::BlockReward => {
                            if block_reward__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockReward"));
                            }
                            block_reward__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ExplorerBlockDetail {
                    hash: hash__.unwrap_or_default(),
                    height: height__.unwrap_or_default(),
                    ...
                    fee_recipient: fee_recipient__.unwrap_or_default(),
                    size: size__.unwrap_or_default(),
                    block_reward: block_reward__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerBlockDetail", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerBlockDetailResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.block_detail.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerBlockDetailResponse", len)?;
        if let Some(v) = self.block_detail.as_ref() {
            struct_ser.serialize_field("blockDetail", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerBlockDetailResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "blockDetail" | "block_detail" => Ok(GeneratedField::BlockDetail),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerBlockDetailResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerBlockDetailResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerBlockDetailResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut block_detail__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::BlockDetail => {
                            if block_detail__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockDetail"));
                            }
                            block_detail__ = map_.next_value()?;
                        }
                    }
                }
                Ok(ExplorerBlockDetailResponse {
                    block_detail: block_detail__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerBlockDetailResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerBlockSummariesResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerBlockSummariesResponse", len)?;
        if !self.block_summaries.is_empty() {
            struct_ser.serialize_field("blockSummaries", &self.block_summaries)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerBlockSummariesResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "blockSummaries" | "block_summaries" => Ok(GeneratedField::BlockSummaries),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerBlockSummariesResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerBlockSummariesResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerBlockSummariesResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut block_summaries__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::BlockSummaries => {
                            if block_summaries__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockSummaries"));
                            }
                            block_summaries__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ExplorerBlockSummariesResponse {
                    block_summaries: block_summaries__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerBlockSummariesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerBlockSummary {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerBlockSummary", len)?;
        if !self.hash.is_empty() {
            struct_ser.serialize_field("hash", &self.hash)?;
        }
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for ExplorerBlockSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerBlockSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerBlockSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerBlockSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut hash__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.ExplorerBlockSummary", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerSearchResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerSearchResponse", len)?;
        if !self.blocks.is_empty() {
            struct_ser.serialize_field("blocks", &self.blocks)?;
        }
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ExplorerSearchResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerSearchResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerSearchResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerSearchResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut blocks__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.ExplorerSearchResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerSummaryResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.genesis_overview.is_some() {
            len += 1;
        }
        if !self.latest_blocks.is_empty() {
            len += 1;
        }
        if !self.latest_transactions.is_empty() {
            len += 1;
        }
        if !self.histograms.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerSummaryResponse", len)?;
        if let Some(v) = self.latest_block.as_ref() {
            struct_ser.serialize_field("latestBlock", v)?;
        }
        if let Some(v) = self.genesis_overview.as_ref() {
            struct_ser.serialize_field("genesisOverview", v)?;
        }
        if !self.latest_blocks.is_empty() {
            struct_ser.serialize_field("latestBlocks", &self.latest_blocks)?;
        }
        if !self.latest_transactions.is_empty() {
            struct_ser.serialize_field("latestTransactions", &self.latest_transactions)?;
        }
        if !self.histograms.is_empty() {
            struct_ser.serialize_field("histograms", &self.histograms)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerSummaryResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "latestBlock" | "latest_block" => Ok(GeneratedField::LatestBlock),
                            "genesisOverview" | "genesis_overview" => Ok(GeneratedField::GenesisOverview),
                            "latestBlocks" | "latest_blocks" => Ok(GeneratedField::LatestBlocks),
                            "latestTransactions" | "latest_transactions" => Ok(GeneratedField::LatestTransactions),
                            "histograms" => Ok(GeneratedField::Histograms),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerSummaryResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerSummaryResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerSummaryResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut latest_block__ = None;
                let mut genesis_overview__ = None;
                let mut latest_blocks__ = None;
                let mut latest_transactions__ = None;
                let mut histograms__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::LatestBlock => {
                            if latest_block__.is_some() {
                                return Err(serde::de::Error::duplicate_field("latestBlock"));
                            }
                            latest_block__ = map_.next_value()?;
                        }
                        GeneratedField::GenesisOverview => {
                            if genesis_overview__.is_some() {
                                return Err(serde::de::Error::duplicate_field("genesisOverview"));
                            }
                            genesis_overview__ = map_.next_value()?;
                        }
                        GeneratedField::LatestBlocks => {
                            if latest_blocks__.is_some() {
                                return Err(serde::de::Error::duplicate_field("latestBlocks"));
                            }
                            latest_blocks__ = Some(map_.next_value()?);
                        }
                        GeneratedField::LatestTransactions => {
                            if latest_transactions__.is_some() {
                                return Err(serde::de::Error::duplicate_field("latestTransactions"));
                            }
                            latest_transactions__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Histograms => {
                            if histograms__.is_some() {
                                return Err(serde::de::Error::duplicate_field("histograms"));
                            }
                            histograms__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ExplorerSummaryResponse {
                    latest_block: latest_block__,
                    genesis_overview: genesis_overview__,
                    latest_blocks: latest_blocks__.unwrap_or_default(),
                    latest_transactions: latest_transactions__.unwrap_or_default(),
                    histograms: histograms__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerSummaryResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerTransactionData {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerTransactionData", len)?;
        if self.namespace != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ExplorerTransactionData {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerTransactionData;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerTransactionData")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerTransactionData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ExplorerTransactionData {
                    namespace: namespace__.unwrap_or_default(),
                    payload: payload__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerTransactionData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerTransactionDetail {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.sequencing_fees.is_empty() {
            len += 1;
        }
        if !self.fee_details.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerTransactionDetail", len)?;
        if !self.hash.is_empty() {
            struct_ser.serialize_field("hash", &self.hash)?;
        }
        if self.height != 0 {
        ...
        if self.block_confirmed {
            struct_ser.serialize_field("blockConfirmed", &self.block_confirmed)?;
        }
        if self.offset != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        if !self.sequencing_fees.is_empty() {
            struct_ser.serialize_field("sequencingFees", &self.sequencing_fees)?;
        }
        if !self.fee_details.is_empty() {
            struct_ser.serialize_field("feeDetails", &self.fee_details)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerTransactionDetail {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "hash" => Ok(GeneratedField::Hash),
                            "height" => Ok(GeneratedField::Height),
                            "blockConfirmed" | "block_confirmed" => Ok(GeneratedField::BlockConfirmed),
                            "offset" => Ok(GeneratedField::Offset),
                            "numTransactions" | "num_transactions" => Ok(GeneratedField::NumTransactions),
                            "size" => Ok(GeneratedField::Size),
                            "time" => Ok(GeneratedField::Time),
                            "sequencingFees" | "sequencing_fees" => Ok(GeneratedField::SequencingFees),
                            "feeDetails" | "fee_details" => Ok(GeneratedField::FeeDetails),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerTransactionDetail;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerTransactionDetail")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerTransactionDetail, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut hash__ = None;
                let mut height__ = None;
                let mut block_confirmed__ = None;
                let mut offset__ = None;
                let mut num_transactions__ = None;
                let mut size__ = None;
                let mut time__ = None;
                let mut sequencing_fees__ = None;
                let mut fee_details__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Hash => {
                            if hash__.is_some() {
                        ...
                        GeneratedField::BlockConfirmed => {
                            if block_confirmed__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockConfirmed"));
                            }
                            block_confirmed__ = Some(map_.next_value()?);
                        }
                        ...
                        GeneratedField::SequencingFees => {
                            if sequencing_fees__.is_some() {
                                return Err(serde::de::Error::duplicate_field("sequencingFees"));
                            }
                            sequencing_fees__ = Some(map_.next_value()?);
                        }
                        GeneratedField::FeeDetails => {
                            if fee_details__.is_some() {
                                return Err(serde::de::Error::duplicate_field("feeDetails"));
                            }
                            fee_details__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ExplorerTransactionDetail {
                    hash: hash__.unwrap_or_default(),
                    height: height__.unwrap_or_default(),
                    block_confirmed: block_confirmed__.unwrap_or_default(),
                    offset: offset__.unwrap_or_default(),
                    num_transactions: num_transactions__.unwrap_or_default(),
                    size: size__.unwrap_or_default(),
                    time: time__.unwrap_or_default(),
                    sequencing_fees: sequencing_fees__.unwrap_or_default(),
                    fee_details: fee_details__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerTransactionDetail", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerTransactionDetailResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerTransactionDetailResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for ExplorerTransactionDetailResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerTransactionDetailResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerTransactionDetailResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerTransactionDetailResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ExplorerTransactionDetailResponse {
                    details: details__,
                    data: data__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerTransactionDetailResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerTransactionSummariesResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if !self.transaction_summaries.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerTransactionSummariesResponse", len)?;
        if !self.transaction_summaries.is_empty() {
            struct_ser.serialize_field("transactionSummaries", &self.transaction_summaries)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ExplorerTransactionSummariesResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "transactionSummaries" | "transaction_summaries" => Ok(GeneratedField::TransactionSummaries),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerTransactionSummariesResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerTransactionSummariesResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerTransactionSummariesResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut transaction_summaries__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::TransactionSummaries => {
                            if transaction_summaries__.is_some() {
                                return Err(serde::de::Error::duplicate_field("transactionSummaries"));
                            }
                            transaction_summaries__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ExplorerTransactionSummariesResponse {
                    transaction_summaries: transaction_summaries__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.ExplorerTransactionSummariesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExplorerTransactionSummary {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.ExplorerTransactionSummary", len)?;
        if !self.hash.is_empty() {
            struct_ser.serialize_field("hash", &self.hash)?;
        }
        if !self.rollups.is_empty() {
            struct_ser.serialize_field("rollups", &self.rollups.iter().map(ToString::to_string).collect::<Vec<_>>())?;
        }
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ExplorerTransactionSummary {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "hash" => Ok(GeneratedField::Hash),
                            "rollups" => Ok(GeneratedField::Rollups),
                            "height" => Ok(GeneratedField::Height),
                            "offset" => Ok(GeneratedField::Offset),
                            "numTransactions" | "num_transactions" => Ok(GeneratedField::NumTransactions),
                            "time" => Ok(GeneratedField::Time),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ExplorerTransactionSummary;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.ExplorerTransactionSummary")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExplorerTransactionSummary, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut hash__ = None;
                let mut rollups__ = None;
                let mut height__ = None;
                let mut offset__ = None;
                let mut num_transactions__ = None;
                let mut time__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Rollups => {
                            if rollups__.is_some() {
                                return Err(serde::de::Error::duplicate_field("rollups"));
                            }
                            rollups__ = 
                                Some(map_.next_value::<Vec<::pbjson::private::NumberDeserialize<_>>>()?
                                    .into_iter().map(|x| x.0).collect())
                ...
                Ok(ExplorerTransactionSummary {
                    hash: hash__.unwrap_or_default(),
                    rollups: rollups__.unwrap_or_default(),
                    height: height__.unwrap_or_default(),
                    offset: offset__.unwrap_or_default(),
                    num_transactions: num_transactions__.unwrap_or_default(),
                    time: time__.unwrap_or_default(),
        ...
        deserializer.deserialize_struct("espresso.api.v2.ExplorerTransactionSummary", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FeeAttribution {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.FeeAttribution", len)?;
        if !self.target.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FeeAttribution {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = FeeAttribution;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.FeeAttribution")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FeeAttribution, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("espresso.api.v2.FeeAttribution", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FeeBalanceResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.FeeBalanceResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for FeeBalanceResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = FeeBalanceResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.FeeBalanceResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FeeBalanceResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(FeeBalanceResponse {
                    balance: balance__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.FeeBalanceResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GenesisOverview {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GenesisOverview", len)?;
        if self.rollups != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("rollups", ToString::to_string(&self.rollups).as_str())?;
        }
        if self.transactions != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("transactions", ToString::to_string(&self.transactions).as_str())?;
        }
        if self.blocks != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("blocks", ToString::to_string(&self.blocks).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GenesisOverview {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GenesisOverview;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GenesisOverview")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GenesisOverview, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut rollups__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.GenesisOverview", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetBlockStatePathRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetBlockStatePathRequest", len)?;
        if let Some(v) = self.key.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("key", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for GetBlockStatePathRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetBlockStatePathRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetBlockStatePathRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetBlockStatePathRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetBlockStatePathRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetExplorerBlockDetailRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerBlockDetailRequest", len)?;
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetExplorerBlockDetailRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerBlockDetailRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerBlockDetailRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerBlockDetailRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                Ok(GetExplorerBlockDetailRequest {
                    height: height__,
                    hash: hash__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerBlockDetailRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetExplorerBlockSummariesRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerBlockSummariesRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetExplorerBlockSummariesRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerBlockSummariesRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerBlockSummariesRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerBlockSummariesRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetExplorerBlockSummariesRequest {
                    limit: limit__,
                    height: height__,
                    hash: hash__,
                })
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerBlockSummariesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetExplorerSearchRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerSearchRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetExplorerSearchRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerSearchRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerSearchRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerSearchRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetExplorerSearchRequest {
                    query: query__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerSearchRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetExplorerSummaryRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerSummaryRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetExplorerSummaryRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerSummaryRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerSummaryRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerSummaryRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(GetExplorerSummaryRequest {
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerSummaryRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetExplorerTransactionDetailRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerTransactionDetailRequest", len)?;
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetExplorerTransactionDetailRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerTransactionDetailRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerTransactionDetailRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerTransactionDetailRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                Ok(GetExplorerTransactionDetailRequest {
                    height: height__,
                    offset: offset__,
                    hash: hash__,
                })
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerTransactionDetailRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetExplorerTransactionSummariesRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetExplorerTransactionSummariesRequest", len)?;
        if let Some(v) = self.limit.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("limit", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetExplorerTransactionSummariesRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetExplorerTransactionSummariesRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetExplorerTransactionSummariesRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetExplorerTransactionSummariesRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut limit__ = None;
                ...
                Ok(GetExplorerTransactionSummariesRequest {
                    limit: limit__,
                    height: height__,
                    offset: offset__,
                    hash: hash__,
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetExplorerTransactionSummariesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetFeeStatePathRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetFeeStatePathRequest", len)?;
        if let Some(v) = self.key.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetFeeStatePathRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetFeeStatePathRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetFeeStatePathRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetFeeStatePathRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetFeeStatePathRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetLatestFeeBalanceRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetLatestFeeBalanceRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetLatestFeeBalanceRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetLatestFeeBalanceRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetLatestFeeBalanceRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetLatestFeeBalanceRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetLatestFeeBalanceRequest {
                    address: address__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetLatestFeeBalanceRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLatestRewardAccountProofRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetLatestRewardAccountProofRequest", len)?;
        if let Some(v) = self.address.as_ref() {
            struct_ser.serialize_field("address", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetLatestRewardAccountProofRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetLatestRewardAccountProofRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetLatestRewardAccountProofRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetLatestRewardAccountProofRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
                ...
                Ok(GetLatestRewardAccountProofRequest {
                    address: address__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetLatestRewardAccountProofRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLatestRewardBalanceRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetLatestRewardBalanceRequest", len)?;
        if let Some(v) = self.address.as_ref() {
            struct_ser.serialize_field("address", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetLatestRewardBalanceRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetLatestRewardBalanceRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetLatestRewardBalanceRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetLatestRewardBalanceRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
                ...
                Ok(GetLatestRewardBalanceRequest {
                    address: address__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetLatestRewardBalanceRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetRewardAmountsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetRewardAmountsRequest", len)?;
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetRewardAmountsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetRewardAmountsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetRewardAmountsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetRewardAmountsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetRewardAmountsRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetRewardMerkleTreeV2Request {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetRewardMerkleTreeV2Request", len)?;
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetRewardMerkleTreeV2Request {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetRewardMerkleTreeV2Request;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetRewardMerkleTreeV2Request")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetRewardMerkleTreeV2Request, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                Ok(GetRewardMerkleTreeV2Request {
                    height: height__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetRewardMerkleTreeV2Request", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetRewardStatePathRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetRewardStatePathRequest", len)?;
        if let Some(v) = self.key.as_ref() {
            struct_ser.serialize_field("key", v)?;
        }
        if let Some(v) = self.height.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetRewardStatePathRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetRewardStatePathRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetRewardStatePathRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetRewardStatePathRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.GetRewardStatePathRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetStateCertV2Request {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetStateCertV2Request", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetStateCertV2Request {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetStateCertV2Request;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetStateCertV2Request")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetStateCertV2Request, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(GetStateCertV2Request {
                    epoch: epoch__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetStateCertV2Request", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetStateHeightRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("espresso.api.v2.GetStateHeightRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetStateHeightRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetStateHeightRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetStateHeightRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetStateHeightRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(GetStateHeightRequest {
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetStateHeightRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetStateSignatureRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.GetStateSignatureRequest", len)?;
        if let Some(v) = self.height.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetStateSignatureRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetStateSignatureRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.GetStateSignatureRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetStateSignatureRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                Ok(GetStateSignatureRequest {
                    height: height__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.GetStateSignatureRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for HistogramPoint {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.block_transactions != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.HistogramPoint", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
        ...
        if self.block_transactions != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("blockTransactions", ToString::to_string(&self.block_transactions).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for HistogramPoint {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "blockTransactions" | "block_transactions" => Ok(GeneratedField::BlockTransactions),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = HistogramPoint;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.HistogramPoint")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<HistogramPoint, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                let mut block_transactions__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Height => {
                            if height__.is_some() {
                        ...
                        GeneratedField::BlockTransactions => {
                            if block_transactions__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockTransactions"));
                            }
                            block_transactions__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                ...
                Ok(HistogramPoint {
                    ...
                    block_transactions: block_transactions__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.HistogramPoint", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MerkleBranch {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.MerkleBranch", len)?;
        if !self.value.is_empty() {
            struct_ser.serialize_field("value", &self.value)?;
        }
        if !self.children.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerkleBranch {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MerkleBranch;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.MerkleBranch")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MerkleBranch, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut value__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.MerkleBranch", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerkleEmpty {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("espresso.api.v2.MerkleEmpty", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MerkleEmpty {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MerkleEmpty;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.MerkleEmpty")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MerkleEmpty, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
        ...
        deserializer.deserialize_struct("espresso.api.v2.MerkleEmpty", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerkleForgottenSubtree {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.MerkleForgottenSubtree", len)?;
        if !self.value.is_empty() {
            struct_ser.serialize_field("value", &self.value)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for MerkleForgottenSubtree {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MerkleForgottenSubtree;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.MerkleForgottenSubtree")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MerkleForgottenSubtree, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut value__ = None;
                ...
                Ok(MerkleForgottenSubtree {
                    value: value__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.MerkleForgottenSubtree", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MerkleLeaf {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.MerkleLeaf", len)?;
        if !self.value.is_empty() {
            struct_ser.serialize_field("value", &self.value)?;
        }
        if !self.pos.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerkleLeaf {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MerkleLeaf;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.MerkleLeaf")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MerkleLeaf, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut value__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.MerkleLeaf", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.node.as_ref() {
            match v {
                ...
                merkle_node::Node::Branch(v) => {
                    struct_ser.serialize_field("branch", v)?;
                }
                merkle_node::Node::Leaf(v) => {
                    struct_ser.serialize_field("leaf", v)?;
                }
                merkle_node::Node::ForgottenSubtree(v) => {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Empty => {
                            ...
                            node__ = map_.next_value::<::std::option::Option<_>>()?.map(merkle_node::Node::Empty)
;
                        }
                        GeneratedField::Branch => {
                            ...
                            node__ = map_.next_value::<::std::option::Option<_>>()?.map(merkle_node::Node::Branch)
;
                        }
                        GeneratedField::Leaf => {
                            if node__.is_some() {
                            ...
                            node__ = map_.next_value::<::std::option::Option<_>>()?.map(merkle_node::Node::Leaf)
;
                        }
                        GeneratedField::ForgottenSubtree => {
                            ...
                            node__ = map_.next_value::<::std::option::Option<_>>()?.map(merkle_node::Node::ForgottenSubtree)
;
                        }
                    }
                }
...
impl serde::Serialize for MerklePathResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.MerklePathResponse", len)?;
        if !self.pos.is_empty() {
            struct_ser.serialize_field("pos", &self.pos)?;
        }
        if !self.proof.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerklePathResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MerklePathResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.MerklePathResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MerklePathResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut pos__ = None;
                ...
                Ok(MerklePathResponse {
                    pos: pos__.unwrap_or_default(),
                    proof: proof__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.MerklePathResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for NamespaceInfo {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.NamespaceInfo", len)?;
        if self.num_transactions != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("numTransactions", ToString::to_string(&self.num_transactions).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NamespaceInfo {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = NamespaceInfo;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.NamespaceInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<NamespaceInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut num_transactions__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.NamespaceInfo", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for RewardAccountProof {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardAccountProof", len)?;
        if !self.account.is_empty() {
            struct_ser.serialize_field("account", &self.account)?;
        }
        if let Some(v) = self.proof.as_ref() {
...
impl<'de> serde::Deserialize<'de> for RewardAccountProof {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardAccountProof;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardAccountProof")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardAccountProof, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut account__ = None;
                ...
                Ok(RewardAccountProof {
                    account: account__.unwrap_or_default(),
                    proof: proof__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardAccountProof", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardAccountProofResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardAccountProofResponse", len)?;
        if !self.balance.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RewardAccountProofResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardAccountProofResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardAccountProofResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardAccountProofResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut balance__ = None;
                ...
                Ok(RewardAccountProofResponse {
                    balance: balance__.unwrap_or_default(),
                    proof: proof__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardAccountProofResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardAmountPair {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardAmountPair", len)?;
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RewardAmountPair {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardAmountPair;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardAmountPair")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardAmountPair, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.RewardAmountPair", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardAmountsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardAmountsResponse", len)?;
        if !self.amounts.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RewardAmountsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardAmountsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardAmountsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardAmountsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(RewardAmountsResponse {
                    amounts: amounts__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardAmountsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardBalanceResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardBalanceResponse", len)?;
        if !self.balance.is_empty() {
            struct_ser.serialize_field("balance", &self.balance)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for RewardBalanceResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardBalanceResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardBalanceResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardBalanceResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut balance__ = None;
                ...
                Ok(RewardBalanceResponse {
                    balance: balance__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardBalanceResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardClaimInputResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardClaimInputResponse", len)?;
        if !self.lifetime_rewards.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RewardClaimInputResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardClaimInputResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardClaimInputResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardClaimInputResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(RewardClaimInputResponse {
                    lifetime_rewards: lifetime_rewards__.unwrap_or_default(),
                    auth_data: auth_data__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardClaimInputResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardMerkleProof {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardMerkleProof", len)?;
        if let Some(v) = self.proof.as_ref() {
            match v {
                reward_merkle_proof::Proof::Presence(v) => {
                    struct_ser.serialize_field("presence", v)?;
                }
                reward_merkle_proof::Proof::Absence(v) => {
...
impl<'de> serde::Deserialize<'de> for RewardMerkleProof {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardMerkleProof;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardMerkleProof")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardMerkleProof, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut proof__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Presence => {
                            ...
                            proof__ = map_.next_value::<::std::option::Option<_>>()?.map(reward_merkle_proof::Proof::Presence)
;
                        }
                        GeneratedField::Absence => {
                            ...
                            proof__ = map_.next_value::<::std::option::Option<_>>()?.map(reward_merkle_proof::Proof::Absence)
;
                        }
                    }
                }
                Ok(RewardMerkleProof {
                    proof: proof__,
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardMerkleProof", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RewardMerkleTreeV2Response {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.RewardMerkleTreeV2Response", len)?;
        if !self.tree.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("tree", pbjson::private::base64::encode(&self.tree).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for RewardMerkleTreeV2Response {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RewardMerkleTreeV2Response;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.RewardMerkleTreeV2Response")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RewardMerkleTreeV2Response, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut tree__ = None;
                ...
                Ok(RewardMerkleTreeV2Response {
                    tree: tree__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.RewardMerkleTreeV2Response", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for StateHeightResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.StateHeightResponse", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for StateHeightResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StateHeightResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.StateHeightResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StateHeightResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                Ok(StateHeightResponse {
                    height: height__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.StateHeightResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StateSignatureResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.v2_signature.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.StateSignatureResponse", len)?;
        if let Some(v) = self.key.as_ref() {
            struct_ser.serialize_field("key", v)?;
        }
        if !self.state.is_empty() {
        ...
        if !self.next_stake.is_empty() {
            struct_ser.serialize_field("nextStake", &self.next_stake)?;
        }
        if !self.auth_root.is_empty() {
            struct_ser.serialize_field("authRoot", &self.auth_root)?;
        }
        ...
        if !self.v2_signature.is_empty() {
            struct_ser.serialize_field("v2Signature", &self.v2_signature)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StateSignatureResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "nextStake" | "next_stake" => Ok(GeneratedField::NextStake),
                            "authRoot" | "auth_root" => Ok(GeneratedField::AuthRoot),
                            "signature" => Ok(GeneratedField::Signature),
                            "v2Signature" | "v2_signature" => Ok(GeneratedField::V2Signature),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = StateSignatureResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.StateSignatureResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StateSignatureResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
                let mut state__ = None;
                let mut next_stake__ = None;
                let mut auth_root__ = None;
                let mut signature__ = None;
                let mut v2_signature__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Key => {
                            if key__.is_some() {
                        ...
                        GeneratedField::NextStake => {
                            if next_stake__.is_some() {
                                return Err(serde::de::Error::duplicate_field("nextStake"));
                            }
                            next_stake__ = Some(map_.next_value()?);
                        }
                        GeneratedField::AuthRoot => {
                            if auth_root__.is_some() {
                                return Err(serde::de::Error::duplicate_field("authRoot"));
                        ...
                        GeneratedField::V2Signature => {
                            if v2_signature__.is_some() {
                                return Err(serde::de::Error::duplicate_field("v2Signature"));
                            }
                            v2_signature__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(StateSignatureResponse {
                    key: key__,
                    state: state__.unwrap_or_default(),
                    next_stake: next_stake__.unwrap_or_default(),
                    auth_root: auth_root__.unwrap_or_default(),
                    signature: signature__.unwrap_or_default(),
                    v2_signature: v2_signature__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("espresso.api.v2.StateSignatureResponse", FIELDS, GeneratedVisitor)
    }
}
