...
impl serde::Serialize for TimeoutCertificate3 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.TimeoutCertificate3", len)?;
        if let Some(v) = self.data.as_ref() {
            struct_ser.serialize_field("data", v)?;
        }
        if !self.vote_commitment.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TimeoutCertificate3 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = TimeoutCertificate3;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.TimeoutCertificate3")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TimeoutCertificate3, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut data__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.TimeoutCertificate3", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TimeoutData3 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("espresso.api.v2.TimeoutData3", len)?;
        if self.view != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("view", ToString::to_string(&self.view).as_str())?;
...
impl<'de> serde::Deserialize<'de> for TimeoutData3 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = TimeoutData3;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct espresso.api.v2.TimeoutData3")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TimeoutData3, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut view__ = None;
        ...
        deserializer.deserialize_struct("espresso.api.v2.TimeoutData3", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.evidence.as_ref() {
            match v {
                ...
                view_change_evidence2::Evidence::Timeout3(v) => {
                    struct_ser.serialize_field("timeout3", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "timeout3" => Ok(GeneratedField::Timeout3),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::Timeout3 => {
                            if evidence__.is_some() {
                                return Err(serde::de::Error::duplicate_field("timeout3"));
                            }
                            evidence__ = map_.next_value::<::std::option::Option<_>>()?.map(view_change_evidence2::Evidence::Timeout3)
;
                        }
                    }
                }
