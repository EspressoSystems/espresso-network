...
pub mod light_client_mock {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            constructor: ::core::option::Option::Some(::ethers::core::abi::ethabi::Constructor {
                inputs: ::std::vec![
                    ...
                    ::ethers::core::abi::ethabi::Param {
                        ...
                        internal_type: ::core::option::Option::Some(
                            ::std::borrow::ToOwned::to_owned("struct LightClient.StakeTableState",),
                        ),
                    },
                    ::ethers::core::abi::ethabi::Param {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("setBlocksPerEpoch"),
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("setBlocksPerEpoch"),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                            name: ::std::borrow::ToOwned::to_owned("newBlocksPerEpoch"),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(64usize),
                            internal_type: ::core::option::Option::Some(
                                ::std::borrow::ToOwned::to_owned("uint64"),
                            ),
    ...
    impl<M: ::ethers::providers::Middleware> LightClientMock<M> {
        ...
        ///Calls the contract's `setBlocksPerEpoch` (0x3c23b6db) function
        pub fn set_blocks_per_epoch(
            &self,
            new_blocks_per_epoch: u64,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([60, 35, 182, 219], new_blocks_per_epoch)
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `setFinalizedState` (0xb5adea3c) function
        pub fn set_finalized_state(
            &self,
            state: LightClientState,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([181, 173, 234, 60], (state,))
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::core::convert::From<MissingLastBlockInEpochUpdate> for LightClientMockErrors {
    ...
    impl ::ethers::contract::EthLogDecode for LightClientMockEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = NewEpochFilter::decode_log(log) {
                return Ok(LightClientMockEvents::NewEpochFilter(decoded));
            }
    ...
    impl ::core::convert::From<NewEpochFilter> for LightClientMockEvents {
    ...
    ///Container type for all input parameters for the `setBlocksPerEpoch` function with signature `setBlocksPerEpoch(uint64)` and selector `0x3c23b6db`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "setBlocksPerEpoch", abi = "setBlocksPerEpoch(uint64)")]
    pub struct SetBlocksPerEpochCall {
        pub new_blocks_per_epoch: u64,
    }
    ///Container type for all input parameters for the `setFinalizedState` function with signature `setFinalizedState((uint64,uint64,uint256))` and selector `0xb5adea3c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "setFinalizedState((uint64,uint64,uint256))"
    )]
    ...
    impl ::ethers::core::abi::AbiDecode for LightClientMockCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <SetBlocksPerEpochCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetBlocksPerEpoch(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ::ethers::core::abi::AbiEncode for LightClientMockCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SetBlocksPerEpoch(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for LightClientMockCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SetBlocksPerEpoch(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<EpochFromBlockNumberCall> for LightClientMockCalls {
        fn from(value: EpochFromBlockNumberCall) -> Self {
            Self::EpochFromBlockNumber(value)
        }
    }
    impl ::core::convert::From<FinalizedStateCall> for LightClientMockCalls {
        fn from(value: FinalizedStateCall) -> Self {
            Self::FinalizedState(value)
        }
    }
    impl ::core::convert::From<GenesisStakeTableStateCall> for LightClientMockCalls {
    ...
    impl ::core::convert::From<IsLastBlockInEpochCall> for LightClientMockCalls {
    ...
    impl ::core::convert::From<SetBlocksPerEpochCall> for LightClientMockCalls {
        fn from(value: SetBlocksPerEpochCall) -> Self {
            Self::SetBlocksPerEpoch(value)
        }
    }
    ...
    impl ::core::convert::From<VotingStakeTableStateCall> for LightClientMockCalls {
