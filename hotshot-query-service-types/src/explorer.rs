...
use crate::{
    Header, HeightIndexed, Payload, Transaction,
    availability::{
...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Error::GetBlockDetail(e) => write!(f, "{e}"),
            Error::GetBlockSummaries(e) => write!(f, "{e}"),
            Error::GetTransactionDetail(e) => write!(f, "{e}"),
            Error::GetTransactionSummaries(e) => write!(f, "{e}"),
            Error::GetExplorerSummary(e) => write!(f, "{e}"),
            Error::GetSearchResults(e) => write!(f, "{e}"),
        }
    }
}
