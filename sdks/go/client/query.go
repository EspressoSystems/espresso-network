...
type QueryService interface {
	...
	FetchRawHeaderByHeight(ctx context.Context, height uint64) (json.RawMessage, TransactionError)
	...
	FetchTransactionByHash(ctx context.Context, hash *types.TaggedBase64) (types.TransactionQueryData, TransactionError)
