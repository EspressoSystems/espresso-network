...
type NamespacePayload = common_types.NamespacePayload
type NamespaceTransactionsRangeData = common_types.NamespaceTransactionsRangeData
type NamespaceTransactionsRangeProof = common_types.NamespaceTransactionsRangeProof
type V1NamespaceTransactionsRangeProof = common_types.V1NamespaceTransactionsRangeProof
type LimitsData = common_types.LimitsData
