...
- V0_7, `LARGE_BLOCK_VERSION` (also `MAX_SUPPORTED_VERSION`): chain-config-only upgrade raising `max_block_size`; reuses
  the V0_5/V0_6 header; first upgrade run by the new protocol's own upgrade sub-protocol
