...
use crate::{
    v0_6::AvidmGf2NsProof, NamespaceId, NsIndex, NsPayload, NsTable, Payload, Transaction,
};
...
mod tests {
    ...
    use crate::{v0::impls::block::test::ValidTest, v0_6::AvidmGf2NsProof, NsIndex, Payload};
    ...
    async fn ns_proof() {
        ...
        let param = AvidmGf2Param::new(5usize, 10usize).unwrap();

        struct BlockInfo {
            block: Payload,
            vid_commit: VidCommitment,
            vid_common: VidCommon,
            ns_proofs: Vec<AvidmGf2NsProof>,
        }
        ...
        let blocks: Vec<BlockInfo> = future::join_all(tests.iter().map(|t| async {
            ...
            BlockInfo {
                ...
                vid_common: VidCommon::V2(vid_common),
                ns_proofs,
            }
        }))
        .await;
        ...
        let vid_common_0 = &blocks[0].vid_common;
        let vid_common_1 = &blocks[1].vid_common;
