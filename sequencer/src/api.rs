...
mod test {
    ...
    async fn test_pos_rewards_basic() -> anyhow::Result<()> {
        ...
        let config = TestNetworkConfigBuilder::with_num_nodes()
            ...
            .pos_hook::<PosVersionV4>(DelegationConfig::VariableAmounts, Default::default())
            .await
            .unwrap()
            .build();
    ...
    #[rstest]
    #[case(PosVersionV4::new(), None)]
    #[case(PosVersionV4::new(), Some(1u64))]
    #[test_log::test(tokio::test(flavor = "multi_thread"))]
    async fn test_token_supply_api<Ver: Versions>(
        #[case] versions: Ver,
