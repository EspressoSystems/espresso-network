...
struct Options {
    ...
    #[arg(long, id = "MIN_SIZE", default_value = "1", value_parser = parse_size, env = "ESPRESSO_SUBMIT_TRANSACTIONS_MIN_SIZE")]
    min_size: u64,

    /// Maximum size of transaction to submit.
    ///
    /// The size of each transaction will be chosen uniformly between MIN_SIZE and MAX_SIZE.
    #[arg(long, id = "MAX_SIZE", default_value = "1kb", value_parser = parse_size, env = "ESPRESSO_SUBMIT_TRANSACTIONS_MAX_SIZE")]
    max_size: u64,
    ...
    #[arg(long, id = "MIN_BATCH_SIZE", default_value = "1", value_parser = parse_size, env = "ESPRESSO_SUBMIT_TRANSACTIONS_MIN_BATCH_SIZE")]
    min_batch_size: u64,

    /// Maximum size of batch of transactions to submit.
    ///
    /// Batches will be a random count between MIN_BATCH_SIZE and MAX_BATCH_SIZE, with a falling distribution favoring smaller batches.
    #[arg(long, id = "MAX_BATCH_SIZE", default_value = "20", value_parser = parse_size, env = "ESPRESSO_SUBMIT_TRANSACTIONS_MAX_BATCH_SIZE")]
    max_batch_size: u64,
    ...
    /// DELAY.
    #[arg(long, id = "DELAY", value_parser = parse_duration, default_value = "30s", env = "ESPRESSO_SUBMIT_TRANSACTIONS_DELAY")]
    delay: Duration,
