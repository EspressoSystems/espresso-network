...
struct Options {
    ...
    /// Address for the first multisig wallet that will be a pauser
    ///
    /// The multisig pauser can pause functions in contracts that have the `whenNotPaused` modifier
    #[clap(
        long,
        name = "MULTISIG_PAUSER1_ADDRESS",
        env = "ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER1_ADDRESS"
    )]
    multisig_pauser1_address: Option<Address>,

    /// Address for the second multisig wallet that will be a pauser
    ///
    /// The multisig pauser can pause functions in contracts that have the `whenNotPaused` modifier
    #[clap(
        long,
        name = "MULTISIG_PAUSER2_ADDRESS",
        env = "ESPRESSO_SEQUENCER_ETH_MULTISIG_PAUSER2_ADDRESS"
    )]
    multisig_pauser2_address: Option<Address>,
...
async fn main() -> anyhow::Result<()> {
    ...
    if let Some(multisig_pauser1) = opt.multisig_pauser1_address {
        args_builder.multisig_pauser1(multisig_pauser1);
    }
    if let Some(multisig_pauser2) = opt.multisig_pauser2_address {
        args_builder.multisig_pauser2(multisig_pauser2);
    }
