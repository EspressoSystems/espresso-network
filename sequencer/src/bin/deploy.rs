...
struct Options {
    ...
    #[arg(short, long, id = "OUT", env = "ESPRESSO_DEPLOYER_OUT_PATH")]
    out: Option<PathBuf>,
    ...
    #[arg(long, env = "ESPRESSO_SEQUENCER_PERMISSIONED_PROVER")]
    ...
    #[arg(long, env = "ESP_TOKEN_INITIAL_GRANT_RECIPIENT_ADDRESS")]
