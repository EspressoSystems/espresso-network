...
#[async_trait]
impl<Types, Ver: StaticVersionType> Provider<Types, LeafRangesRequest>
    for TrustedQueryServiceProvider<Ver>
where
    Types: NodeType,
{
...
#[async_trait]
impl<Types, Ver: StaticVersionType> Provider<Types, BlockRangesRequest>
    for TrustedQueryServiceProvider<Ver>
where
    Types: NodeType,
{
...
#[async_trait]
impl<Types, Ver: StaticVersionType> Provider<Types, VidCommonRangesRequest>
    for TrustedQueryServiceProvider<Ver>
where
    Types: NodeType,
{
...
mod test {
    ...
    use crate::{
        ...
        availability::{
            ...
            Certificate2, Fetch, UpdateAvailabilityData, VidCommonQueryData, define_api,
        },
        data_source::{
